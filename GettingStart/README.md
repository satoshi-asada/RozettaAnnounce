...
<img src="https://github.com/rozetta/RozettAnnounce/blob/master/assets/github-02-02-620x521.png" class="img-responsive" >
3. ここまでGitHubのアカウント登録は完了。
4. Two-factor authenticationを設定する (Google Authenticatorがお勧めです。)
<img src="https://github.com/rozetta/RozettAnnounce/blob/master/assets/github-authen.png" class="img-responsive" >
